...
trait Transactions
{
     ...
     */
    protected function fetchTransaction(int $id)
    {
        $curl = curl_init();
     ...
     */
    protected function traitExportTransactions()
    {
        $curl = curl_init();
     ...
     */
    protected function traitExportFilteredTransactions(string $status)
    {
        $curl = curl_init();

        curl_setopt_array($curl, [
            CURLOPT_URL => "https://api.paystack.co/transaction/export?status={$status}",
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 30,
